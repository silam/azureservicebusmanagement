...
namespace topic_send
{
    class Program
    {
        private static string _bus_connectionstring = "Endpoint=sb://az204servicebussection8.servicebus.windows.net/;SharedAccessKeyName=sharedpolicy;SharedAccessKey=yijkidzsCYDJ1FMuTSeAH/aQDvw5DWKOI7/djwHVr08=";
        private static string _management_connection_string = "Endpoint=sb://az204servicebussection8.servicebus.windows.net/;SharedAccessKeyName=sharedpolicymanagement;SharedAccessKey=IWNDXbvs21+tKPPhKaOcvr7tvB1S3IYdveTkC1qgOUA=;EntityPath=apptopic";
